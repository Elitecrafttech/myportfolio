      ...
      <div className='lg:ml-[220px] flex flex-col gap-[50px]'>
        <div data-aos="fade-up" className='flex flex-col md:flex-row gap-[40px] items-center justify-center'>
          ...
          <div className='fadeInUp flex flex-col gap-[10px] p-[15px]'>
            <h1 data-aos="fade-up" className='font-bold text-[50px] md:text-[60px] text-[#D9DAE7]'>About Me</h1>
            <h2 data-aos="fade-up" className='elite text-[27px]'>Fullstack Developer</h2>
            ...
            <div className='flex flex-col lg:flex-row items-start lg:items-center gap-[20px]  md:gap-[50px]'>
              <div className='flex flex-col gap-[20px]'>
                <p data-aos="fade-up" className='flex items-center gap-[15px]'><span className='text-[hsla(51,100%,50%,1)]'><FaUserTie /></span>Elitecraft Tech</p>
                <p data-aos="fade-up" className='flex items-center gap-[15px]'><span className='text-[hsla(51,100%,50%,1)]'><FaWhatsapp /></span>+234 704 171 7579</p>
              </div>
              <div className='flex flex-col gap-[20px]'>
                <p data-aos="fade-up" className='flex items-center gap-[15px]'><span className='text-[hsla(51,100%,50%,1)]'><FaTelegram /></span>@Elitecraft_tech</p>
                <p data-aos="fade-up" className='flex items-center gap-[15px]'><span className='text-[hsla(51,100%,50%,1)]'><MdOutlineMarkEmailRead /></span>Elitecrafttech@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
        <div className='flex flex-wrap md:items-center justify-center gap-[80px] md:gap-[20px] lg:gap-[85px]'>
          <div data-aos="fade-up" className='flex items-center gap-[20px] shadow-xl p-[60px] md:p-[20px] rounded-lg'>
